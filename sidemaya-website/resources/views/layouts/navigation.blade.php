<nav x-data="{ open: false }" class="border-b border-gray-100 dark:border-gray-700" style="background: green; border-color: DarkGreen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('ajukansurat')" :active="request()->routeIs('ajukansurat')">
                            {{ __('Ajukan Surat') }}
                        </x-nav-link>
            ...
            @auth
                ...
                @else
                <a href="{{ route('login') }}" class="font-semibold text-gray-100 hover:text-gray-300 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 bg-darkGreen px-3 py-2 rounded-md">Log in</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-100 hover:text-gray-300 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 bg-darkGreen px-3 py-2 rounded-md">Register</a>
                @endif
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('layanan-umum')" :active="request()->routeIs('layanan-umum')">
                {{ __('Layanan Umum') }}
            </x-responsive-nav-link>
        </div>
